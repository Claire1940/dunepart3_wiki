...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Dune Part 3 Wiki',
    description: 'Dune Part 3 Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Dune Part Three movie fan guide. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Dune Part 3 Wiki (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;) collects minimal information to provide and improve our services.
            ...
            <ul>
              ...
              <li><strong>Language Preferences:</strong> We store your language preference in your browser&rsquo;s local storage to enhance your experience.</li>
            ...
            <p>
              ...
              Learn more about <a href="https://privacy.microsoft.com/en-us/privacystatement" target="_blank" rel="noopener noreferrer" className="text-[hsl(var(--nav-theme-light))] hover:underline">Microsoft&rsquo;s privacy practices</a>.
            </p>
            ...
            <p>
              Our website may contain links to external websites, including the official Dune movie site, Warner Bros. Pictures,
              and social media platforms. We are not responsible for the privacy practices or content of these third-party sites.
            ...
            <p>
              We comply with the Children&rsquo;s Online Privacy Protection Act (COPPA) and do not knowingly collect,
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Dune Part 3 Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Warner Bros. Pictures, Legendary, Denis Villeneuve, or the rights holders of Dune: Part Three. All movie content,
              trademarks, and assets are the property of their respective owners.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@dunepart3.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@dunepart3.wiki</a>
            </p>
            <p>
