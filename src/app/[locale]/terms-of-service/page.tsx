...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Dune Part 3 Wiki",
    description: "Read the Terms of Service for Dune Part 3 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Dune Part Three movie fan guide.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Dune Part 3 Wiki",
      description: "Terms and conditions for using Dune Part 3 Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Dune Part 3 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Dune Part 3 Wiki (&ldquo;the Website&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;), you agree to be bound
              by these Terms of Service (&ldquo;Terms&rdquo;). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you (&ldquo;User&rdquo;, &ldquo;you&rdquo;, or &ldquo;your&rdquo;) and Dune Part 3 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Dune Part 3 Wiki is an unofficial, community-driven fan website that provides information, guides, and resources
              related to the movie &ldquo;Dune: Part Three&rdquo;. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Release date and theatrical availability updates</li>
              <li>Official trailer and teaser coverage</li>
              <li>Cast, character, and story guides</li>
              <li>IMAX and premium format information</li>
              <li>Dune Messiah book adaptation connections</li>
              <li>Timeline and watch-order guides</li>
            </ul>
            <p>
              <strong>Important:</strong> Dune Part 3 Wiki is NOT affiliated with, endorsed by, or associated with
              Warner Bros. Pictures, Legendary, Denis Villeneuve, or the rights holders of Dune: Part Three. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Dune Part 3 Wiki and are protected by international
              copyright, trademark, and other intellectual property laws.
            </p>

            <h3>4.2 Movie Content</h3>
            <p>
              All movie-related content, including but not limited to posters, stills, trailers, character names, logos, and
              trademarks, are the property of Warner Bros. Pictures and/or Legendary and/or their respective rights holders. We use such
            ...
            <ul>
              <li><strong>Accuracy:</strong> We strive to provide accurate information, but we do not guarantee that all content is current, complete, or error-free. Release dates, cast details, and trailer availability may change without notice.</li>
              ...
              <li><strong>External Links:</strong> Content on linked third-party websites is outside our control and may change without notice.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, DUNE PART 3 WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including the official Dune movie site, Warner Bros. Pictures,
              social media platforms, and other external resources. These links are provided for your convenience only.
            </p>
            <p>
            ...
            <p>
              ...
              you and Dune Part 3 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@dunepart3.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@dunepart3.wiki</a>
            </p>
            <p>
